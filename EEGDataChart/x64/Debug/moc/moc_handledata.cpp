...
QT_MOC_LITERAL(1, 11, 16), // "send_Handle_Data"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "HandleData\0send_Handle_Data\0"
};
...
void HandleData::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->send_Handle_Data(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HandleData::send_Handle_Data)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void HandleData::send_Handle_Data()
{
